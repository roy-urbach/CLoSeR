...
D_OVER_ACC_F = lambda ax=None, inp_name='image': XTICKS_PERC_F(ax=ax) and XLABEL_PERC_F(ax=ax, inp_name=inp_name) and YLABEL_CLASS_F(ax=ax)
...
class NamesAndColors(Enum):
    ...
    UNTRAINED = NameAndColor("untrained model", color='brown')
