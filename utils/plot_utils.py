...
XTICKS_PERC_F = lambda ax=None: (ax.set_xlim if ax else plt.xlim)(0, 1) and (ax.set_xticks if ax else plt.xticks)(np.linspace(0, 1, 11), [f"{d if d else ''}0%" for d in range(0,11)])
